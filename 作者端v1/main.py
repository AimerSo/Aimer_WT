...
class AppApi:
    ...
    def export_voicepack_bank(self, folder_name, package_name=""):
        try:
            return self._voicepack.export_voicepack_bank(folder_name, package_name or "")
        except Exception as e:
            return {"success": False, "msg": str(e)}
